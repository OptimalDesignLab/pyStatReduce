...
axes[j].set_ylabel(r'approximation error, $\epsilon_{variance}$')
...
plt.tight_layout()
plotname = ''.join(['./plot_data/variance_accuracy/approximation_error_bar_systemsize', str(systemsize_arr[i]), '.pdf'])
