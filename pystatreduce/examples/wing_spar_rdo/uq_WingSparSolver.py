...
from pystatreduce.examples.wing_spar_rdo.source.WingSparSolver import SparSolver
...
class UQSparSolver(QuantityOfInterest):
    ...
    def eval_stress_con_qoi(self, mean_val, perturbation):
        ...
        con_val =  self.det_spar_solver_obj.eval_ineq_cnstr(self.dv)
        return con_val
    ...
    def init_design(self):
        ...
        x0[self.nelem+1:] = 0.0085*np.ones(self.nelem+1)
        return x0
