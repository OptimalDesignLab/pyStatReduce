...
class RandomQuadratic(QuantityOfInterest):
    ...
    def __init__(self, systemsize, **kwargs):
        ...
        # mat = np.array([[0.669963, 0.227424, 0.871246, 0.910015, 0.403449, 0.491179, 0.255712, 0.510808, 0.303675, 0.747969],
        ...
        # self.V, self.R = np.linalg.qr(mat)
        # self.E = np.array([0.0561565,0.180111,0.187385,0.348511,0.474983,0.674096,0.787899,0.860523,0.916701,0.948724])
